...
public class LargePurchaseGoalImportancePage extends TestBase 
{
	...
	public static Logger log = Logger.getLogger(LargePurchaseGoalImportancePage.class);
	...
	{	
		...
		log.info("Goal Selected is : "+driver.findElement(By.id(LargePurchaseGoalImportancePage.riskXpath)).getText());
	...
	public ArrayList<Object> getPageContent()
	{
		...
		log.info("Risk SCreen Header is : "+driver.findElement(By.xpath(prop.getProperty("largepurchaseriskscreenheader"))).getText());
		log.info("Risk Screen Sub-header is : "+driver.findElement(By.xpath(prop.getProperty("riskscreensubheader"))).getText());
		log.info("Full Star risk : "+driver.findElement(By.id(prop.getProperty("fullStartRisk"))).getText());
		log.info("Half Star risk is : "+driver.findElement(By.id(prop.getProperty("halfstartRisk"))).getText());
		log.info("No Risk is : "+driver.findElement(By.id(prop.getProperty("noStartRisk"))).getText());
		log.info("Phone image is displayed : "+driver.findElement(By.xpath(prop.getProperty("phoneimg"))).isDisplayed());
		log.info("Have questions is displayed : "+driver.findElement(By.id(prop.getProperty("haveqtns"))).getText());
		log.info("Advisor call details displayed : "+driver.findElement(By.id(prop.getProperty("advisor"))).getText());
