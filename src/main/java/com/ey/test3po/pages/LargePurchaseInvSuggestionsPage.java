...
public class LargePurchaseInvSuggestionsPage extends TestBase
{
	...
	// Logger.getLogger(LargePurchaseInvSuggestionsPage.class);
	...
	public ArrayList<Object> getPageContentOfInvestmentSuggestion()
	{
		...
		/*
		 * log.info("Large Purchase Planned Contribution page Header is : " +
		 * driver.findElement(By.xpath(prop.getProperty(
		 * "largepurchaseinvsuggestionheader"))).getText());
		 * log.info("Large Purchase Planned Contribution page Sub-header is : " +
		 * driver.findElement(By.xpath(prop.getProperty(
		 * "largepurchaseinvsuggestionsubheader"))).getText()); log.
		 * info("Large Purchase Planned Contribution page plan suggestion is displayed : "
		 * +
		 * driver.findElement(By.xpath(prop.getProperty("largepurchasesuggestedplan"))).
		 * isDisplayed()); log.
		 * info("Large Purchase Planned Contribution page plan how much you can afford text is displayed : "
		 * +
		 * driver.findElement(By.xpath(prop.getProperty("suggestedplansub"))).getText())
		 * ; log.
		 * info("Large Purchase Planned Contribution page contributin suggestion box is displayed : "
		 * +
		 * driver.findElement(By.xpath(prop.getProperty("plannedinvsuggestiontextbox")))
		 * .isDisplayed());
		 * log.info("Large Purchase Planned Contribution page check box is displayed : "
		 * + driver.findElement(By.id(prop.getProperty("invsuggestionchkbox"))).
		 * isDisplayed()); log.
		 * info("Large Purchase Planned Contribution page contribution textbox tip is displayed : "
		 * +
		 * driver.findElement(By.id(prop.getProperty("invsuggestiontextboxdescription"))
		 * ).getText()); log.
		 * info("Large Purchase Planned Contribution page image in the text box displayed : "
		 * + driver.findElement(By.id(prop.getProperty("escimg"))).isDisplayed()); log.
		 * info("Large Purchase Planned Contribution page planned contribution placeholder text is displayed : "
		 * +
		 * driver.findElement(By.xpath(prop.getProperty("invsuggestionplaceholdertxbox")
		 * )).getText());
		 */
	...
	public void setMonthlyContribution(String amount, String key, boolean flag, String checkbox, String goalamount, String plannedcontribution, String plannedinvamount, String age)
	{
		...
		// pagecontentafterclick = getPageContentAfterClickZeroContribution(flag,
		// goalamount);
	...
	public static ArrayList<Object> getPageContentAfterClickOfInvestmentSuggestion(boolean flag, String goalamount)
	{
		...
		// log.info("Based on the entered planned monthly amount, the affordability
		// amount is : " + affordabilitytxt);
		...
		if (flag == true && Double.parseDouble(affordabilitytxt.replaceAll("[^0-9]", "")) < Double.parseDouble(goalamount))
		{
			...
			// log.info("Suggested investment amount in the pop up is : " +
	...
	public ArrayList<Object> getPageContentOfInvestmentSuggestionMoreThan55(String plannedinvamount)
	{
		 ...
		 * info("Large Purchase Planned Contribution page plan suggestion is displayed : "
		 * + driver.findElement(By.xpath(prop.getProperty(
		 * "largepurchasesuggestedplanMoreThan55"))).isDisplayed()); log.
		 * info("Large Purchase Planned Contribution page plan how much you can afford text is displayed : "
		 * +
		 * driver.findElement(By.xpath(prop.getProperty("suggestedplansub"))).getText())
		 * ; log.
