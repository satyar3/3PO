...
public class OtherGoalImportancePage extends TestBase
{
	...
	public void riskFactor(String riskfactor, String key)
	{
		...
		driver.findElement(By.id(OtherGoalImportancePage.riskXpath)).click();
	...
	public ArrayList<Object> getPageContentOfGoalImportance()
	{
		...
		pagecontent.add(driver.findElement(By.xpath(prop.getProperty("othergoalriskscreenheader"))).getText());
