...
public class LargePurchaseUserSignUpJourneyMoreThan55Test extends TestBase{
	...
	public void largePurchaseGoalMoreThan55(String annualincome, String zip, String age,
	...
	{		
		...
		ArrayList<Object> pagecontentPlannedInv = plannedinv.getPageContentMoreThan55();
		...
		if(Double.parseDouble(plannedinvamt)<Double.parseDouble(suggestedinvestment) && Double.parseDouble(suggestedaffordability1) < Double.parseDouble(goalamount))
		{
			...
			ArrayList<Object> pagecontentInvSuggestion = plannedinvsuggestions.getPageContentMoreThan55();			
