...
public class EducationGoalUserSignUpJourneyLessThan55Test extends TestBase{
	...
	public void educationGoalLessThan55(String annualincome, String zip, String age, 
			...
			String suggestedcontribution, String suggestedaffordability1, String suggestedcurrentasset, String suggestedaffordability2, String checkbox, String key)
	{
		...
		ArrayList<Object> plannedinvsuggestionpagecontent = plannedinvsuggestions.getPageContent();
		...
		if (Double.parseDouble(plannedcontributionamt) < Double.parseDouble(suggestedcontribution) && Double.parseDouble(suggestedaffordability1) < Double.parseDouble(yearlyexp)) 
		{
			...
			ArrayList<Object> monthlyinvestmentpagecontent = plannedinv.getPageContent();
